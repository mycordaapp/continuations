...
class ContinuationScenarios {
    ...
    @Test
    fun `should wire up Continuation using registry`() {
    ...
    fun `should return result of previous run if rerun `() {
        ...
        assertThat(spy1.secrets(), equalTo(listOf("step1", "step2", "step3")))
        ...
        assertThat(spy2.secrets(), equalTo(emptyList()))
    }
    ...
    fun `should retry failed steps using retry strategy`() {
        ...
        assertThat(spy.secrets(), equalTo(listOf("step1", "step2", "step2", "step2", "step2", "step3")))
